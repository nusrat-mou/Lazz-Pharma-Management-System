...
<div class="content">
 ...
 <form id="form4" name="form4" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']) ?>" method="POST" novalidate >
  ...
  <fieldset>
    ...
    <label for="nid">Enter Nid to delete their values:</label>
    <input type="text" id="nid" name="nid" placeholder="Please fill this blank"><br><br>
    <label for="nid"></label>
  <input type="submit" value="Submit">
 <br> <br>
